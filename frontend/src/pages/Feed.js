                            ...
                            return (
                                <button
                                    ...
                                    className={`w-9 h-9 rounded-full grid place-items-center transition tap-shrink ${
                                        active ? "chip-on" : "text-black hover:bg-black/[0.06]"
                                    }`}
                                >
            ...
            <div className="sticky top-[var(--mobile-topbar-h)] lg:top-[81px] z-20 glass border-b border-black/[0.06]">
                ...
                <div className="flex gap-1.5 px-3 pb-2.5 overflow-x-auto scrollbar-hide">
                    <button
                        ...
                        className={`shrink-0 px-3 py-1 rounded-full text-[12px] font-medium transition ${mood === "" ? "chip-on" : "bg-black/[0.04] text-black hover:bg-black/[0.08]"}`}
                    >
                        Tudo
                    </button>
                    {MOOD_OPTIONS.map((m) => (
                        <button
                            ...
                            className={`shrink-0 inline-flex items-center gap-1 px-3 py-1 rounded-full text-[12px] font-medium transition ${mood === m.key ? "chip-on" : "bg-black/[0.04] text-black hover:bg-black/[0.08]"}`}
                        >
